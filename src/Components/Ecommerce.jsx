  ...
  return (
    <>
      <div className="container font-serif flex flex-col min-h-screen min-w-full">
        ...
        {/* CHILDREN COMPONENTS */}
        <div className="componentsContainer flex-1 p-[5vw] font-serif">
          <Outlet />
        </div>

        {/* FOOTER */}
        <footer className="footerContainer flex-shrink-0 flex justify-center items-center w-full text-xl text-center text-gray-100 p-[20px] bg-slate-500 h-[15vh] sm:text-2xl">
