                  ...
                  >
                    ...
                    <div className="text-center">
                      ...
                      <button
                        ...
                        className=" px-5 py-2 mx-2 text-lg rounded-2xl bg-red-600 hover:bg-red-700 text-white duration-200 "
                      >
                        Remove
                      </button>
                      <button
                        onClick={() => {
                          removingItem(index);
                          alert(
                            `Thank you for your order! Your item/s will be prepared and shipped soon. \n\n ${
                              product.name
                            }: PHP ${(
                        ...
                        className=" px-5 py-2 mx-2  text-lg rounded-2xl bg-orange-600 hover:bg-orange-700 text-white duration-200 "
                      >
                        Check Out
                      </button>
                    </div>
